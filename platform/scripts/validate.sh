...
OUTPUT_FILE="/tmp/${COMPONENT_NAME}-rendered.yaml"
...
[[ -s "${OUTPUT_FILE}" ]] ||
  fail "O Helm não gerou manifestos."

log "Validando manifestos com kubectl"
...
log "Arquivo renderizado: ${OUTPUT_FILE}"
